...
#    make program = Download the hex file to the device, using msp430-bsl. 
#                   Please customize the msp430-bsl
...
ASRC = $(ROOT_DIR)/src/kernel/hal/$(MCU)/msp430_hw_specific.S
...
# -fpack-struct was here but taken out since it messes up alignment on msp430
...
################################# MSP430-BSL ###################################
MSP430BSL = msp430-bsl
MSP430BSL_FLAGS = --telosb -c $(PROGRAMMING_PORT) -r -e -p
...
ALL_CFLAGS = -mmcu=$(MCU) -I. $(CFLAGS) $(TARGET_PLATFORM)
...
program: $(TARGET).hex 
ifeq ($(PROG_TYPE),msp430-bsl)
	$(MSP430BSL) $(MSP430BSL_FLAGS) $(TARGET).hex
endif
