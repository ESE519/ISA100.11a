...
#define BUTTON          7  // P2.7 - Input button 0
...
#define UART1_RXD       7 // P3.7 - Input:  UART1 RXD
#define UART1_TXD       6 // P3.6 - Output: UART1 TXD
#define SFD             1 // P4.1 - Input:  SFD from CC2420
#define CCA             4 // P1.4 - Input:  CCA from CC2420
#define LED_0           4 // P5.4 - Output: LED 1 (red)
#define LED_1           5 // P5.5 - Output: LED 2 (green)
#define LED_2           6 // P5.6 - Output: LED 3 (blue)
#define LED_3           5 // PE.2 - Output: Red LED [no 4th led on tmote!!!!!]
#define UART0_RXD       5 // P3.5 - Input:  UART0 RXD
#define UART0_TXD       4 // P3.4 - Output: UART0 TXD
//#define SPI_SS          0  // PB.0 - Output: SPI Slave Select [now P4.2]
#define FIFOP           0 // P1.0 - Input:  FIFOP from CC2420
#define ADC_INPUT_0     0 // P6.0
#define ADC_INPUT_1     1 // P6.1 - ADC1
#define ADC_INPUT_2     2 // P6.2 - ADC2
#define ADC_INPUT_3     3 // P5.3 - ADC3
#define ADC_INPUT_4     4 // P5.3 - ADC3
#define ADC_INPUT_5     5 // P5.3 - ADC3
#define ADC_INPUT_6     6 // P6.6 - ADC3
#define ADC_INPUT_7     7 // P6.7 - ADC3
