...
#define MAX_APP_PAYLOAD  40  					// maximum size of the application payload in bytes 
#define MAX_SERIAL_PAYLOAD 32  					// maximum size of serial data payload
#define MAX_GATEWAY_PAYLOAD 40 				// payload size from gateway to node
...
#define MAX_NETWORK_DIAMETER 20		// maximum number of hops to the gateway
