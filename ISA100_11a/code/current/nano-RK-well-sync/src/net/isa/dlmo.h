...
extern void sendPacket(uint16_t destAddr, uint8_t length, uint8_t *payload, void (*slot_callback)(ISA_QUEUE *entry, status)) ;
extern DLMO_LINK * findLink(uint8_t slot);
extern bool isTransmitLinkPresent (uint16_t neighborAddr);
